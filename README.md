...
Welcome to Task Master Pro, a comprehensive Java application designed to manage tasks efficiently. This project is developed and maintained by Gerald,
...
1. Clone the repository:
    ...
    ```sh
    git clone https://github.com/GeraldAkenji/Tasks-Project.git
    cd Task-Master-Pro
    ```
